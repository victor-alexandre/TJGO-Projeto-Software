...
### Req01 - Criar README do Projeto

**Objetivo:** Documentar informações essenciais para novos colaboradores.
**Atividades:**

- Descrever stack tecnológica.
- Instruções de instalação e execução.
- Estrutura básica do repositório.
  **Resultado esperado:** README completo e publicado no Git.

---

### Req02 - Criar MER do Banco

**Objetivo:** Representar conceitualmente entidades e relacionamentos.
**Atividades:**

- Levantar entidades e atributos.
- Definir relacionamentos principais.
- Criar diagrama em ferramenta adequada (ex: [http://Draw.io](http://Draw.io smartCard-inline") 
  **Resultado esperado:** MER revisado e validado pela equipe." REQUISITOS (pink)

---

### Req03 - Criar DER do Banco

**Objetivo:** Produzir modelo lógico a partir do MER.
**Atividades:**

- Criar tabelas, chaves primárias e estrangeiras.
- Normalizar dados.
- Definir tipos de dados e restrições.
  **Resultado esperado:** DER pronto para implementação no banco.

---

### Req04 - Redigir Casos de Uso Detalhados

**Objetivo:** Documentar fluxos de interação com o sistema.
**Atividades:**

- Descrever atores, pré-condições e fluxos alternativos.
- Validar com stakeholders.
- Criar versão revisada no repositório.
  **Resultado esperado:** Casos de uso formalizados e completos.

---

### Req05 - Criar Documento de Requisitos Não Funcionais

**Objetivo:** Definir critérios de qualidade do sistema.
**Atividades:**

- Documentar requisitos de segurança, desempenho, disponibilidade.
- Definir métricas de aceitação (ex: resposta < 3s).
  **Resultado esperado:** Documento de RNF validado pela equipe.